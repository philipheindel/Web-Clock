...
<body>
    ...
    <div class="dropdown">
        <select name="timezone_offset" id="timezoneOffset" class="form-control">
            ...
            <option value="+5">(GMT +5:30) Bombay, Calcutta, Madras, New Delhi</option>
            <option value="+5">(GMT +5:45) Kathmandu, Pokhara</option>
            <option value="+6">(GMT +6:00) Almaty, Dhaka, Colombo</option>
            <option value="+6">(GMT +6:30) Yangon, Mandalay</option>
            ...
            <option value="+11">(GMT +11:30) Norfolk Island</option>
            <option value="+12">(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka</option>
            <option value="+12">(GMT +12:45) Chatham Islands</option>
            <option value="+13">(GMT +13:00) Apia, Nukualofa</option>
            <option value="+14">(GMT +14:00) Line Islands, Tokelau</option>
        </select>
        <div>
            <button onclick = " resetTime(); showTheTime(timezoneOffset.value);">test</button>
        </div>
    </div>
</body>
